...
output$map_chart = renderHighchart({
  ...
  agg_i = aggregate(confirmed$X3.22.20, by=list(confirmed$Country.Region), sum)
  agg_ii = aggregate(confirmed$X3.21.20, by=list(confirmed$Country.Region), sum)
  agg_iii = aggregate(confirmed$X3.20.20, by=list(confirmed$Country.Region), sum)
